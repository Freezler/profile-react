...
const navigationMenuTriggerStyle = cva(
  'group inline-flex justify-center items-center bg-background data-[active]:bg-accent/50 data-[state=open]:bg-accent/50 hover:bg-accent focus:bg-accent disabled:opacity-50 px-4 py-2 rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-bright-pink focus-visible:ring-offset-2 w-max h-9 font-medium text-sm transition-colors hover:text-accent-foreground focus:text-accent-foreground disabled:pointer-events-none',
  {
    variants: {
      active: {
        true: 'bg-accent/50',
